...
* https://commoncriteria.github.io/enterprise-session-controller/release-2.0/enterprise-session-controller.html[Protection Profile for Enterprise Session Controller v2.0]
